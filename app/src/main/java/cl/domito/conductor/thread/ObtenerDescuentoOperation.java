...
import cl.domito.conductor.activity.DescuentoActivity;
...
public class ObtenerDescuentoOperation extends AsyncTask<Void, Void, JSONArray> {

    private WeakReference<DescuentoActivity> context;
    private RecyclerView recyclerView;
    private ProgressBar progressBar;

    public ObtenerDescuentoOperation(DescuentoActivity activity) {
        context = new WeakReference<DescuentoActivity>(activity);
