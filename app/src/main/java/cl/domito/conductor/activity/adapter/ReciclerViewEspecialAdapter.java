...
public class ReciclerViewEspecialAdapter extends RecyclerView.Adapter<ReciclerViewEspecialAdapter.MyViewHolder> {
    ...
    public ReciclerViewEspecialAdapter(Activity activity, String[] myDataset) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int position) {
        ...
        vh.relativeLayout3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(activity, ServicioDetalleEspecialActivity.class);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.textViewFecha.setText(data[2]);
        myViewHolder.textViewCliente.setText(data[1]);
